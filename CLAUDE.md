...
- [docs/product/v1/](docs/product/v1/) — design source-of-truth (binary `.docx`, not directly readable):
...
- [docs/product/SRS_Document.md](docs/product/SRS_Document.md) — full software requirements spec, including the **23 business rules (BL-01 → BL-23)** that every implementation must enforce.
- [docs/testing/v1/Test_Cases.md](docs/testing/v1/Test_Cases.md) — ~110 test cases with traceability back to the business rules.
...
- **When scaffolding the application**, the two `.docx` files in `docs/product/v1/` are the authoritative spec — read or have the user excerpt them before making product/UX decisions.
