...
// Slot 5 is rendered as a "More" tile that opens a bottom sheet containing
// the overflow items (Users, Properties, Audit Log, My Profile) and an
// explicit Logout action. Users is demoted from the tab bar to the sheet
// because it's the least-daily of the original five.
//
...
// Items shown in the More sheet for Admin. Icons + hrefs are copied verbatim
// from NAV_ITEMS / PROFILE_NAV above so the same tile renders identically.
